...
- Other approaches: silhouette (graphical approachto evaluating cluster fit), Akaike information criterion(AIC)and Bayesianinformation criterion(BIC)measure relative quality of models and factors inthe number of parameters
