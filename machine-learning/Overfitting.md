...
2. Training data need descrease. Usually less features means less training data needed
...
Steps:
    ...
    4. Keep the top ! principal components to reduce into a lower dimension
